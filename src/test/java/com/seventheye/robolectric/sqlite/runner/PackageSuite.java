...
public class PackageSuite extends ParentRunner<Runner> {
	...
	public static Runner emptySuite() {
		try {
			return new PackageSuite((Class<?>)null, new Class<?>[0]);
	...
	private static Class<?>[] getAnnotatedPackage(Class<?> klass) throws InitializationError {
		...
		String pack = annotation.value();
			...
			try {
				return filterTests(getClasses(pack));
	 ...
	 * @throws InitializationError
	 */
	protected PackageSuite(Class<?> klass, Class<?>[] suiteClasses) throws InitializationError {
	 ...
	 * @throws InitializationError
	 */
	protected PackageSuite(RunnerBuilder builder, Class<?> klass, Class<?>[] suiteClasses) throws InitializationError {
		super(klass);
		builder = new SQLiteRunnerBuilder();
